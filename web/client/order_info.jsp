    ...
    <div class="row">
        ...
        <div style="margin:0 auto;margin-top:10px;width:950px;">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach var="ol" items="${orders.orderitemList}">
                    <tr class="active">
                        <td width="60" width="40%">
                            <input type="hidden" name="id" value="22">
                            <img src="${pageContext.request.contextPath}/${ol.product.pimage}" width="70" height="60">
                        </td>
                        <td width="30%">
                            <a target="_blank">${ol.product.pname}</a>
                        </td>
                        <td width="20%">
                            ￥${ol.product.shop_price}
                        </td>
                        <td width="10%">
                                ${ol.count}
                        </td>
                        <td width="15%">
                            <span class="subtotal">&yen;${ol.subtotal}</span>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
        ...
        <div style="text-align:right;margin-right:120px;">
            商品金额: <strong style="color:#ff6600;">&yen;${orders.total}元</strong>
        </div>
