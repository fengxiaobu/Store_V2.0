    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" id="menu_id">
...
<script>
    $(function () {
        ...
        $("#code_img").click(function () {
            //alert("验证码切换");
            //document.getElementById("code_img").src = "${pageContext.request.contextPath}/CheckImgServlet?time=" + new Date().getTime();
            $("#code_img").prop("src", "${pageContext.request.contextPath}/CheckImgServlet?time=" + new Date().getTime());
        });
    });
</script>