    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            ...
            <div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
                ...
                <p><a href="${pageContext.request.contextPath}/client/product_info.jsp" style='color:#666'>冬瓜</a></p>
    ...
    <div class="container-fluid">
        ...
        <div style="text-align: center;margin-top: 5px;">
            <ul class="list-inline">
                <li><a href="${pageContext.request.contextPath}/client/info.jsp">关于我们</a></li>
                <li><a>联系我们</a></li>
                <li><a>招贤纳士</a></li>
                <li><a>法律声明</a></li>
                <li><a>友情链接</a></li>
