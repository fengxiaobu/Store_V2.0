...
<head>
    ...
    <title>会员登录</title>
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/client/css/bootstrap.min.css"
          type="text/css"/>
    <script
            src="${pageContext.request.contextPath}/client/js/jquery-1.11.3.min.js"
            type="text/javascript"></script>
    <script
            src="${pageContext.request.contextPath}/client/js/bootstrap.min.js"
            type="text/javascript"></script>
    <!-- 引入自定义css文件 style.css -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/client/css/style.css"
          type="text/css"/>
...
<div class="container">
    <div class="row">
        ...
        <form id="form_cart" action="${pageContext.request.contextPath}/CartServlet" method="post">
                ...
                <div class="col-md-6">
                    ...
                    <div
                        ...
                        <div style="margin: 20px 0 10px 0;; text-align: center;">
                            <a href="javascript:document.getElementById('form_cart').submit()"> <input
...
<div style="margin-top: 50px;">
    <img
            src="${pageContext.request.contextPath}/image/footer.jpg" width="100%" height="78" alt="我们的优势"
            title="我们的优势"/>
</div>
